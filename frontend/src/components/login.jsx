...
const Login = () => {
  ...
  return (
    <div className="container">
      ...
      <form className="form border bolder-2 border-info rounded rounded-3 p-3" onSubmit={login}>
        ...
        <div className="row">
          <small className={"form-text text-center " + (formText ? "text-danger" : "")}>{formText || "Fill the form to log into"}</small>
        </div>
        <div className="row">
